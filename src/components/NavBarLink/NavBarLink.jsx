...
const NavBarLink = () => {
  ...
  <div class="container flex flex-wrap items-center justify-between mx-auto text-gray-100">
    <NavLink
      class="mr-4 block cursor-pointer py-1.5 text-base text-gray-200 font-semibold" to="/">
      Rutas React
    </NavLink>
    <div class="hidden lg:block">
      <ul class="flex flex-col gap-2 mt-2 mb-4 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
        <li class="flex items-center p-1 text-sm gap-x-2 text-gray-200">
          <NavLink class="flex items-center" to="/">Home</NavLink>
        </li>
        <li class="flex items-center p-1 text-sm gap-x-2 text-gray-200">
          <NavLink class="flex items-center" to="/contact">Contactos</NavLink>
        </li>
        <li class="flex items-center p-1 text-sm gap-x-2 text-gray-200">
          <NavLink class="flex items-center" to="/project">Proyectos</NavLink>
        </li>
        <li class="flex items-center p-1 text-sm gap-x-2 text-gray-200">
